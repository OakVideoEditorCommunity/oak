# Oak overlay of vcpkg's x264 port (baseline 771b0a2e7c473c3a6bee56553be4d5bb32bb653c).
# The only change: the source comes from the GitHub mirror `mirror/x264`
# instead of code.videolan.org, whose GitLab serves the archive behind an
# anti-bot challenge — CI runners intermittently could not download it
# (curl 7 / 404), which made every vcpkg install a coin flip. The mirror
# archive is byte-identical (same SHA512), so only the fetch URL changes.
# The other port files are verbatim copies; refresh them when vcpkg's
# builtin baseline moves.
